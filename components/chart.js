        ...
        <View style={{ flex: 1,
            ...
            alignItems: 'center',}}>
                ...
                <VictoryPie
                    ...
                    style={{
                        labels: {
                            fill: 'black', fontSize: 12, padding:30, fontWeight: 'bold'
                ...
                />
                <Text style={{ fontSize: 12, fontWeight: "bold", borderColor: theme.colors.tertiary, borderWidth: 3, padding: 10, borderRadius: 3,}} >
                {`Total : ${numberFormat((23400).toFixed(0))}`}
                </Text>



                {//if props.table==='yes'?renderTable(props.tableData):null}
